...
export class CpuAddressingHelper {
   ...
   * @param x The current X
   */
  public atDirectPageIndexedIndirectX(
    regPC: DoubleByteRegister,
    x: ByteRegister
  ) {
   ...
   * @param y The current Y
   */
  public atDirectPageIndirectIndexedY(
    regPC: DoubleByteRegister,
    y: ByteRegister
  ) {
    const baseLowByte = this.atDirectPage(regPC);
  ...
  public crossesPageBoundaryAtAbsoluteIndexedX(
    regPC: DoubleByteRegister,
    x: ByteRegister
  ): boolean {
    const baseAddress = this.atAbsolute(regPC);
  ...
  public crossesPageBoundaryAtAbsoluteIndexedY(
    regPC: DoubleByteRegister,
    y: ByteRegister
  ): boolean {
    const baseAddress = this.atAbsolute(regPC);
   ...
   * @param y
   */
  public crossesPageBoundaryAtDirectPageIndirectIndexedY(
    regPC: DoubleByteRegister,
    y: ByteRegister
  ) {
    const baseLowByte = this.atDirectPage(regPC);
